...
class ProductTypeTest extends CsvTestBase {
  ...
  public function testProductType() {
    $this->assertProductTypeEntity('bag_accessory', 'Bag Accessory', '', 'default');
    $this->assertProductTypeEntity('mens_short_sleeve_t_shirts', 'Mens Short Sleeve T-Shirts', '', 'default');
    $this->assertProductTypeEntity('mens_t_shirt', 'Mens T-Shirt', '', 'default');
  }
