...
class CommerceFieldNameTest extends MigrateProcessTestCase {
  ...
  protected function setUp(): void {
    ...
    $this->processPluginManager = $this->createMock('Drupal\migrate\Plugin\MigratePluginManagerInterface');
    $this->makeEntityUnique = $this->createMock('Drupal\migrate\Plugin\migrate\process\MakeUniqueEntityField');
