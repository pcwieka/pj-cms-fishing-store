...
class TaxonomyCategoriesTermTest extends CsvTestBase {
  ...
  public function testTaxonomyTerm() {
    $this->assertTermEntity(1, 'Clothing', 'categories', '', NULL, 0, [0]);
    ...
    $this->assertTermEntity(6, 'Posters', 'categories', '', NULL, 0, [0]);
    $this->assertTermEntity(7, 'Music', 'categories', '', NULL, 0, [0]);
