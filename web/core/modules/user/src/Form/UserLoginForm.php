  ...
  public function validateFinal(array &$form, FormStateInterface $form_state) {
    ...
    if (!$form_state->get('uid')) {
      ...
      if ($flood_control_triggered = $form_state->get('flood_control_triggered')) {
        ...
        $form_state->setErrorByName('name', $this->t('Unrecognized username or password. <a href=":password">Nie pamiętasz hasła?</a>', [':password' => Url::fromRoute('user.pass', [], ['query' => $query])->toString()]));
